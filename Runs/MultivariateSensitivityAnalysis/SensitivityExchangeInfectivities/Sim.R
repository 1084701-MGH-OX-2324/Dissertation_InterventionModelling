...
file_name <-("Master_SARS-CoV-2_Influenza_Bolivia_Shielding_Lockdown_None_Range0.3_Steps3_ModelRuns.xlsx")
file <- read_excel("Master_SARS-CoV-2_Influenza_Bolivia_Shielding_Lockdown_None_Range0.3_Steps3_ModelRuns.xlsx", sheet = "Runs")
